					...
					<table class="w-full text-sm text-left text-gray-500">
						...
						<tbody>
							...
							<tr class="bg-white border-b ">
								...
								<td class="px-6 py-4">
									<div class="flex w-32 font-bold justify-between  "><a href="#" class="font-medium text-blue-600 hover:underline">Edit</a><a href="#" class="font-bold  hover:underline text-red-600 hover:underline">Delete</a></div>
								</td>
							</tr>
